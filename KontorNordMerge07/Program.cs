namespace merge2projektknontornord
{
    namespace ProjektNordUgevisning_Aflysning_af_møde_isa
    {
        ...
        internal class Program
        {
                        ...
                        case 2:
                            {
                                ...
                                //Yukari forklaring --> bool isConfirmed til break:                               
                                /* bool isConfirmed tager return værdien fra ConfirmMeeting metoden som tager 2 parametere,
                        ...
                        case ConsoleKey.N:
                            {
                                ...
                                //Yukari forklaring --> bool isConfirmed til break:
                                //Her kalder vi metoden: ConfirmMeeting som tager newMeeting og selectedRoom som parametre.
            ...
            // Yukari forklaring ---> static bool ConfirmMeeting metode
            ...
            */
            static bool ConfirmMeeting(Meeting meeting, MeetingRoom selectedRoom)
            {
                ...
                /* While-loop , der kører og tjekker indtil brugeren skriver "ja" eller "nej". 
